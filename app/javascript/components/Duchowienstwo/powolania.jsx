...
import powolania from "./../img/ksieza/powolania.jpg";
    ...
    <div className="inne-row">
      <animated.div style={props}>
        <div className="buttons-box text-center">
          <h2>Obecny powolania</h2>
          <h3 className="text-center h3-header">Ks. Bogdan Ignasiak</h3>
          <div className="ob-powolaniaowie-overlay">
            <img src={powolania} className="ob-powolaniaowie-img " />
            <p className="ob-powolaniaowie-text">
              {" "}
